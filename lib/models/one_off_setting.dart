...
List<ProjectClassificationOneOffSettings> projectClassificationOneOffSettingsFromJson(String str) => List<ProjectClassificationOneOffSettings>.from(json.decode(str).map((x) => ProjectClassificationOneOffSettings.fromJson(x)));

String projectClassificationOneOffSettingsToJson(List<ProjectClassificationOneOffSettings> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProjectClassificationOneOffSettings {
  ProjectClassificationOneOffSettings({
    required this.id,
    required this.name,
  ...
  factory ProjectClassificationOneOffSettings.fromJson(Map<String, dynamic> json) => ProjectClassificationOneOffSettings(
    id: json["id"],
    name: json["name"],
